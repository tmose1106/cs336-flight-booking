...
<body>
    ...
    <form action="AddFlightServlet" method="post"> 
	    ...
	    <input type="text" step=1 name="departDate" pattern="\d+{4}/\d+{2}/\d+{2}" required minlength="16" maxlength="16">
	    <br>
	    ...
	    <input type="text" step=1 name="arrivalDate" pattern="\d+{4}/\d+{2}/\d+{2}" required minlength="16" maxlength="16">
	    <br>
